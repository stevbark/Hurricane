...
public class ItemsAndBonuses 
{
	...
	public static final Item potionitem = new Item(new Rectangle(itemicon_x*Tile.size,icon_y*Tile.size,Tile.size,Tile.size),0,0,Tile.potion_icon);
	public static final Item bandaiditem = new Item(new Rectangle(itemicon_x*Tile.size,icon_y*Tile.size,Tile.size,Tile.size),0,0,Tile.band_aid_icon);
	public static final Item castitem = new Item(new Rectangle(itemicon_x*Tile.size,icon_y*Tile.size,Tile.size,Tile.size),0,0,Tile.cast_icon);
	public static final Item fooditem = new Item(new Rectangle(itemicon_x*Tile.size,icon_y*Tile.size,Tile.size,Tile.size),0,0,Tile.food_icon);
	//Bonuses
